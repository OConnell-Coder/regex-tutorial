...
If we look at our email address example again, we can see that there are three bracket expressions. One for the username, one for the domain name, and one for the domain type (.com, .edu, .org, etc.).
